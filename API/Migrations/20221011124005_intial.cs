    ...
    public partial class intial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvitedMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvitedMembers_Boards_BoardsId",
                        column: x => x.BoardsId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvitedMembers_User_User_Id",
                        column: x => x.User_Id,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberBoard", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemberBoard_Boards_BoardsId",
                        column: x => x.BoardsId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MemberBoard_User_User_Id",
                        column: x => x.User_Id,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonInCharge = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Card", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Card_List_List_Id",
                        column: x => x.List_Id,
                        principalTable: "List",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Card_MemberBoard_PersonInCharge",
                        column: x => x.PersonInCharge,
                        principalTable: "MemberBoard",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberCard_Card_Card_Id",
                        column: x => x.Card_Id,
                        principalTable: "Card",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberCard_User_User_Id",
                        column: x => x.User_Id,
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Card_List_Id",
                table: "Card",
                column: "List_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Card_PersonInCharge",
                table: "Card",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvitedMembers_BoardsId",
                table: "InvitedMembers",
                column: "BoardsId");

            migrationBuilder.CreateIndex(
                name: "IX_InvitedMembers_User_Id",
                table: "InvitedMembers",
                column: "User_Id");

            migrationBuilder.CreateIndex(
                name: "IX_List_BoardsId",
                table: "List",
                column: "BoardsId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberBoard_BoardsId",
                table: "MemberBoard",
                column: "BoardsId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberBoard_User_Id",
                table: "MemberBoard",
                column: "User_Id");

            migrationBuilder.CreateIndex(
                name: "IX_MemberCard_Card_Id",
                table: "MemberCard",
                column: "Card_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Role_Level_Id",
                table: "Role",
                column: "Level_Id");

            migrationBuilder.CreateIndex(
                name: "IX_TaskCard_Card_Id",
                table: "TaskCard",
                column: "Card_Id");
